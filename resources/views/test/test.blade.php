        ...
        <div id="top" class="page" role="document">
            ...
            <main role="main">
                <section id="notification">
                    <div class="alert alert-dismissible note-primary fade show" role="alert">
                        <button type="button" class="close" data-dismiss="alert">
                            <span aria-hidden="true">&times;</span>
                        </button>
                        <h3>Primary</h3>
                        <p>Some primary action stuff happened.</p>
                    ...
                    <div class="alert alert-dismissible note-info" role="alert">
                        <button type="button" class="close" data-dismiss="alert">
                            <span aria-hidden="true">&times;</span>
                        </button>
                        <strong>Success!</strong> Better check yourself, you're not looking too good.
                    ...
                    <div class="alert alert-dismissible note-warning" role="alert">
                        <button type="button" class="close" data-dismiss="alert">
                            <span aria-hidden="true">&times;</span>
                        </button>
                        <strong>Success!</strong> Better check yourself, you're not looking too good.
                    ...
                    <div class="alert alert-dismissible note-danger" role="alert">
                        <button type="button" class="close" data-dismiss="alert">
                            <span aria-hidden="true">&times;</span>
                        </button>
                        <strong>Success!</strong> Better check yourself, you're not looking too good.
                    ...
                    <div class="alert alert-dismissible note-error" role="alert">
                        <button type="button" class="close" data-dismiss="alert">
                            <span aria-hidden="true">&times;</span>
                        </button>
                        <strong>Success!</strong> Better check yourself, you're not looking too good.
                ...
                <section id="text">
                    ...
                    <article id="text__blockquotes">
                        ...
                        <div>
                            <blockquote>
                                <p>A block quotation (also known as a long quotation or extract) is a quotation in a
                                    written
    ...
    p q r s t u v w x y z { | } ~ </pre>
                    ...
                    <article id="text__inline">
                        ...
                        <div>
                            ...
                            <p>The <b>b element</b> is stylistically different text from normal text, without any
                                special
                                importance.</p>
                            ...
                            <p><q cite="https://developer.mozilla.org/en-US/docs/HTML/Element/q">This text is a short
                                    inline
                                    quotation.</q></p>
                ...
                <section id="embedded">
                    ...
                    <article id="embedded__images">
                        ...
                        <div>
                            ...
                            <h3>Wrapped in a <code>&lt;figure&gt;</code> element, with a <code>&lt;figcaption&gt;</code>
                            </h3>
                            <figure>
                ...
                <section id="forms">
                    ...
                    <form>
                        <fieldset id="forms__input">
                            ...
                            <div>
                                <label for="input__text5" class="datetime">Datetime</label>
                                <input id="input__text5" class="is-valid" type="datetime-local" placeholder="Date">
                            </div>
                        </fieldset>
                        ...
                        <fieldset id="forms__checkbox">
                            ...
                            <ul class="formulario-checkbox">
                                <li><label for="check1"><input id="check1" name="checkbox" type="checkbox">
                                        Stuff</label>
                                </li>
                                <li><label for="check2"><input id="check2" name="checkbox" type="checkbox">
                                        Stuff</label>
                                </li>
                                <li><label for="check3"><input id="check3" name="checkbox" type="checkbox">
                                        Stuff</label>
                                </li>
                            </ul>
                            <div class="form-checkbox">
                                <ul class="list list--bare">
                                    ...
                                    <li><label for="checkbox2"><input id="checkbox2" name="checkbox" type="checkbox">
                                            Choice
                                            B</label></li>
                                    <li><label for="checkbox3"><input id="checkbox3" name="checkbox" type="checkbox">
                                            Choice
                                            C</label></li>
                                </ul>
                            </div>
                        ...
                        <fieldset id="forms__radio">
                            ...
                            <ul class="formulario-checkbox">
                                <li><label for="radio1"><input id="radio1" name="radio" type="radio" class="radio"
                                                               checked="checked">Option 1</label></li>
                                <li><label for="radio2"><input id="radio2" name="radio" type="radio" class="radio">Option
                                        2</label>
                                </li>
                                <li><label for="radio3"><input id="radio3" name="radio" type="radio" class="radio">Option
                                        3</label>
                                </li>
                            </ul>
                        </fieldset>
