<section id="area_carrossel">
    ...
    {{--Botão que aparece caso o último banner seja muito velho--}}
    @if($carrosselTooOld)
        <div id="carrossel-no-new-items-button"></div>
    @endif

    {{--Área do Carrossel--}}
    <div id="carrossel-items" class="hidden container slick">
        @foreach($carrossel as $item)
            <article>
                ...
                <div class="carrossel-content">
                    <div class="carrossel-content-header">
                        <h1>
                            {{ $item->artigo->titulo }}
                        </h1>
                    </div>
                    <div class="carrossel-content-tldr">
                        <span>
                            {{ $item->artigo->tldr }}
                        </span>
                    </div>
                    <div class="carrossel-content-button">
                        <a>Leia Mais</a>
                    </div>
                </div>
            </article>
