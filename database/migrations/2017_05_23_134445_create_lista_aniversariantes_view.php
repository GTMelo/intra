    ...
    public function up()
    {
        DB::statement(
             'CREATE VIEW view_aniversariantes AS
                  ...
                  WHERE  DATE_ADD(rh_dados.data_nascimento, INTERVAL YEAR(CURDATE())-YEAR(rh_dados.data_nascimento) + IF(DAYOFYEAR(CURDATE()) > DAYOFYEAR(rh_dados.data_nascimento),1,0) YEAR) BETWEEN CURDATE() AND DATE_ADD(CURDATE(), INTERVAL 15 DAY)
