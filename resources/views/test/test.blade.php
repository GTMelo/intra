...
@section('content')
    ...
    {{--<li><label for="check1"><input id="check1" name="checkbox" type="checkbox"> Stuff</label>--}}
    {{--</li>--}}
    {{--<li><label for="check2"><input id="check2" name="checkbox" type="checkbox"> Stuff</label>--}}
    {{--</li>--}}
    {{--<li><label for="check3"><input id="check3" name="checkbox" type="checkbox"> Stuff</label>--}}
    {{--</li>--}}
    {{--</ul>--}}
